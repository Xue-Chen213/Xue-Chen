...
extern volatile uint8_t Packet_Ready;   // 新增：完整数据包就绪标志

typedef struct
{
	uint8_t header[12];//包头
	uint16_t adcx[320];//振动数据存储
...
//定义引脚有关宏函数
#define ADS124S08_START_Pin         GPIO_PIN_2
#define ADS124S08_START_GPIO_Port   GPIOA
#define ADS124S08_CS_Pin            GPIO_PIN_3
#define ADS124S08_CS_GPIO_Port      GPIOA
#define ADS124S08_DRDY_Pin          GPIO_PIN_4
#define ADS124S08_DRDY_GPIO_Port    GPIOA
#define ADS124S08_DRDY_EXTI_IRQn    EXTI4_IRQn
#define   AD_nCS_LOW	HAL_GPIO_WritePin(ADS124S08_CS_GPIO_Port,ADS124S08_CS_Pin, GPIO_PIN_RESET)
#define   AD_nCS_HIGH	HAL_GPIO_WritePin(ADS124S08_CS_GPIO_Port,ADS124S08_CS_Pin, GPIO_PIN_SET)

#define   AD_START_LOW	HAL_GPIO_WritePin(ADS124S08_START_GPIO_Port,ADS124S08_START_Pin,GPIO_PIN_RESET)
#define   AD_START_HIGH	HAL_GPIO_WritePin(ADS124S08_START_GPIO_Port,ADS124S08_START_Pin,GPIO_PIN_SET)

#define   nAD_DRDY_STATE  HAL_GPIO_ReadPin( ADS124S08_DRDY_GPIO_Port,ADS124S08_DRDY_Pin ) 
